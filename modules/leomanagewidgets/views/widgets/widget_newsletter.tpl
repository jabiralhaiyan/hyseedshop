...
<script type="text/javascript">
	var placeholder_leomanagewidgets = '{l s='Enter your e-mail' mod='leomanagewidgets' js=1}';
{if isset($msg) && $msg}
	var msg_newsl = "{$msg|@addcslashes:'\''}";
{/if}
{if isset($nw_error)}
	var nw_error = '{$nw_error}';
{/if}
{if isset($msg) && $msg}
	var alert_leomanagewidgets = "{l s='Newsletter : %1$s' sprintf=$msg js=1 mod='leomanagewidgets'}";
{/if}
