	...
	<div class="block_various_links" id="block_various_links_footer">
		...
		<ul>
			...
			{if isset($display_poweredby) && $display_poweredby}
				<li class="last_item">{l s='[1]Ecommerce software by %s[/1]' mod='blockcms' sprintf=['Hyssed Farm™'] tags=['<a class="_blank" href="https://web.facebook.com/hyseedhidroponik">']}</li>
			{/if}
		</ul>
		{$footer_text}
	</div>
