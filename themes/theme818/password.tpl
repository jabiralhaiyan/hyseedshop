...
{if isset($confirmation) && $confirmation == 1}
	...
	{elseif isset($confirmation) && $confirmation == 2}
		<p class="alert alert-success"><button class="close" data-dismiss="alert" type="button">×</button> {l s='A confirmation email has been sent to your address:'} {if isset($email)}{$email|escape:'htmlall':'UTF-8'|stripslashes}{/if}</p>
	{else}
